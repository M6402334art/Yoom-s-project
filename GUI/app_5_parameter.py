...
class MainWindow(QWidget):
    ...
    def predict(self):
        ...
        if df is None:
            ...
            testDf = df.iloc[:30]
            sc = joblib.load(f'{os.getcwd()}/../models/scaler_5_parameter.pkl') #change path if it not run
            model = joblib.load(f'{os.getcwd()}/../models/best_5_parameter.pkl') #change path if it not run
